...
public class ElseConditionalStrategy : StatementStrategy
{
    private readonly Parser _parser;
    private readonly ConditionalFactory _conditionalFactory;

    public ElseConditionalStrategy()
    {
        _parser = new Parser();
    ...
    {
        if (tokens[position] != "CHAYPI")
            throw new Exception("Syntax error in conditional statement");
        position += 3;
        ...
        return new ElseConditionalStmt { Value = statements };
    }
}
